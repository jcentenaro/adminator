...
export const NAV = [
  {
    ...
    items: [
      { key: 'dashboard', text: 'Panel de control', href: 'index.html',
        icon: '<path d="M3 12 12 3l9 9"/><path d="M5 10v10h14V10"/>' },
      { key: 'docs', text: 'Documentación', href: 'https://adminator.colorlib.com/docs/', badge: { kind: 'new', text: 'DOCS' },
        icon: '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>' },
      { key: 'pro', text: 'Hazte Pro', href: 'https://dashboardpack.com/?utm_source=colorlib&utm_medium=adminator-demo&utm_campaign=sidebar-go-pro', badge: { kind: 'pro', text: 'PRO' },
  ...
  },
  {
    label: 'Componentes',
    items: [
      { key: 'charts', text: 'Gráficos', href: 'charts.html', badge: { kind: 'new', text: 'NUEVO' },
        icon: '<path d="M3 20V4M7 20v-6M11 20v-10M15 20v-4M19 20V8"/>' },
      { key: 'forms', text: 'Formularios', href: 'forms.html',
        icon: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 10h10M7 14h7"/>' },
      { key: 'ui', text: 'Elementos UI', href: 'ui.html',
        icon: '<circle cx="12" cy="12" r="9"/><path d="M8 12h8M12 8v8"/>' },
      { key: 'buttons', text: 'Botones', href: 'buttons.html',
        icon: '<rect x="3" y="8" width="18" height="8" rx="4"/>' },
      { key: 'tables', text: 'Tablas',
        icon: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 10h18M3 16h18M9 4v16"/>',
        children: [
          { key: 'basic-table', text: 'Tabla básica', href: 'basic-table.html' },
          { key: 'datatable',   text: 'Tabla de datos',  href: 'datatable.html' },
        ],
      },
      { key: 'maps', text: 'Mapas',
        icon: '<path d="M9 20V4l6 4v16z"/><path d="M3 7l6-3v16l-6 3z"/><path d="M15 8l6-3v16l-6 3"/>',
        children: [
          { key: 'google-maps', text: 'Mapa de Google', href: 'google-maps.html' },
          { key: 'vector-maps', text: 'Mapa vectorial', href: 'vector-maps.html' },
        ],
      },
      { key: 'pages', text: 'Páginas',
        icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>',
        children: [
          { key: 'blank',   text: 'En blanco',   href: 'blank.html' },
          { key: '404',     text: '404',     href: '404.html' },
          { key: '500',     text: '500',     href: '500.html' },
          { key: 'signin',  text: 'Iniciar sesión', href: 'signin.html' },
          { key: 'signup',  text: 'Registrarse', href: 'signup.html' },
        ],
      },
    ],
  },
  ...
  return `
    <header class="d-topbar">
      ...
      <div class="topbar-actions">
        ...
        <div class="dd-wrap">
          <button class="icon-btn" data-dropdown aria-label="Notificaciones">
          ...
          <div class="dd-menu" role="menu">
            ...
            <div class="dd-list">
              <a class="dd-item" href="#">
                ...
                <div class="dd-body">
                  <div class="dd-text">A <strong>John Doe</strong> le gustó tu <em>publicación</em></div>
                  <div class="dd-time">HACE 5 MIN</div>
                </div>
              </a>
              <a class="dd-item" href="#">
                <div class="dd-avatar a2">MD</div>
                <div class="dd-body">
                  <div class="dd-text">A <strong>Moo Doe</strong> le gustó tu <em>foto de portada</em></div>
                  <div class="dd-time">HACE 7 MIN</div>
                </div>
              </a>
              <a class="dd-item" href="#">
                <div class="dd-avatar a3">LD</div>
                <div class="dd-body">
                  <div class="dd-text"><strong>Lee Doe</strong> comentó en tu <em>video</em></div>
                  <div class="dd-time">HACE 10 MIN</div>
                </div>
              </a>
            </div>
            <a class="dd-footer" href="#">Ver todas las notificaciones →</a>
          </div>
        </div>

        <div class="dd-wrap">
          <button class="icon-btn" data-dropdown aria-label="Mensajes">
          ...
          <div class="dd-menu" role="menu">
            ...
            <div class="dd-list">
              <a class="dd-item" href="#">
                ...
                <div class="dd-body">
                  ...
                  <div class="dd-preview">¿Quieres crear tu propio generador de datos personalizado para tu app?...</div>
                </div>
              </a>
              <a class="dd-item" href="#">
                <div class="dd-avatar a2">MD</div>
            ...
            <a class="dd-footer" href="#">Ver todos los mensajes →</a>
          </div>
        </div>
        ...
        <div class="dd-wrap">
          ...
          <div class="dd-menu dd-profile" role="menu">
            ...
            <a class="dd-menu-item" href="#">
              <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83-2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
              Configuración
            </a>
            <a class="dd-menu-item" href="#">
